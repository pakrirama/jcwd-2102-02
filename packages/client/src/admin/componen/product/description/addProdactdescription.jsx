...
export default function App(props){
  ...
  const formik = useFormik({
    ...
    onSubmit: async () =>{
        ...
        contradictory ,
        how_to_save ,
        packaging , } = formik.values




        try{
            await axiosInstance.post("/product_description/", {...formik.values,id:val} ).then(()=>{
...
compotition
                ...
                <Input
                  ...
                  rounded="md"
                  onChange={(e)=>{
                    formik.setFieldValue('compotition', e.target.value)
                }}
                />
              </FormControl>
              <FormControl as={GridItem} colSpan={[6, 4]}>
...
how_to_use
                ...
                <Input
                  ...
                  rounded="md"
                  onChange={(e)=>{
                    formik.setFieldValue('how_to_use', e.target.value)
                }}
                />
              </FormControl>
              <FormControl as={GridItem} colSpan={[6, 4]}>
...
side_effects                </FormLabel>
                <Input
                  ...
                  rounded="md"
                  onChange={(e)=>{
                    formik.setFieldValue('side_effects', e.target.value)
                }}
                />
              </FormControl>
              <FormControl as={GridItem} colSpan={[6, 4]}>
...
contradictory
                ...
                <Input
                  ...
                  rounded="md"
                  onChange={(e)=>{
                    formik.setFieldValue('contradictory', e.target.value)
                }}
                />
              </FormControl>
              <FormControl as={GridItem} colSpan={[6, 4]}>
...
how_to_save
                ...
                <Input
                  ...
                  rounded="md"
                  onChange={(e)=>{
                    formik.setFieldValue('how_to_save', e.target.value)
                }}
                />
              </FormControl>
              <FormControl as={GridItem} colSpan={[6, 4]}>
