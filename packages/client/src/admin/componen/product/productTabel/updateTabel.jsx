    ...
    const formik = useFormik({
      ...
      onSubmit: async () => {
        ...
        try {
          ...
          await axiosInstance.patch(`/product/update/ ${idUp} ` , formData).then(() => {
            ...
            <ModalBody pb={6}>
              <Box display='flex' flexWrap='wrap' justifyContent='space-evenly'>
                ...
                <Box maxW='400px' maxH='350px' objectFit='fill'>
                  <Image src={`${upImage}`} w='400px' h='350px' objectFit='cover' rounded={5} />
                </Box>
                ...
                <Box mt='10px'>
                  <FormControl>
                    ...
                    <Textarea placeholder='name' maxLength='2000' w='400px' h='150px'
                      onChange={(e) => {
                  ...
                  <FormControl mt='10px'>
                    ...
                    <Input placeholder='code' maxLength='2000' w='400px'
                      onChange={(e) => {
                  ...
                  <FormControl mt='10px'>
                    ...
                    <Input placeholder='price' maxLength='2000' w='400px'
                      onChange={(e) => {
