    ...
    onSubmit: async () =>{
        ...
        try{
          let body = {
            ...
            await axiosInstance.post(`/product_category/`, qs.stringify(body) ).then(()=>{
...
>
  <Box>
    ...
    onChange={(e)=>{
      formik.setFieldValue('id_category1', e.target.value)
  }}>
...
// defaultValue={val.category}
onChange={(e)=>{
formik.setFieldValue('id_category2', e.target.value)
}}>
{category.map((val,index)=>(
