import {
   ...
   <LinkNext href='/admin/product/addNewproduct'>
       <Box display='flex' my='5px' style={router.pathname == '/admin/product/addNewproduct'  ? { textDecoration: "none", color: '#00ACEE' ,borderBottomWidth: '3px',background: '#E8F5FD' }
                       : { textDecoration: "none" }} 
