...
import ForgotPass from '../../../user/componen/auth/ForgotPass';
...
import Page from '../../../user/componen/upTag/upTag';
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      usernameEmail: Yup.string()
        ...
        .min(8, 'UsernameEmail should be of man 8 characters length'),
      password: Yup.string()
